...
- Automatically starts the OneMCP service
...
# Output:
# OneMCP Service (8080): healthy (uptime: 2h 15m)
```
...
- Required directory present (`apis/`)
- Recommended directories available (`docs/`, `state/`)
...
**Arguments:**
- `service` (optional) - Service name (`app`)
