---
description: Validate your foundation folder structure before running OneMCP.
---
...
- Missing required files (Agent.yaml, docs, APIs)
...
```bash
# Navigate to the OneMCP service
cd packages/server 
...
============================================================
✅ ✓ Agent.yaml found and validated
...
💡 To fix validation errors:
   1. Ensure Agent.yaml exists and contains proper agent instructions
...
**Solution:**
```bash
# Create Agent.yaml with minimal content
cat > Agent.yaml << 'EOF'
# My Agent
