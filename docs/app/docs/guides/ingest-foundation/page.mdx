...
This checks for:
- Required files (Agent.yaml, docs/, apis/)
...
- [Managing Multiple Handbooks](/docs/guides/handbook-management) - Organize multiple AI agents
- [Validate your foundation](/docs/guides/foundation-validation) - Ensure your foundation is correct
- [Run with Docker](/docs/guides/run-with-docker) - Deploy your agent
- Learn about [Retrieval concepts](/docs/concepts/retrieval) - How agents find information
