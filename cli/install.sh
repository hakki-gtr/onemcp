...
post_install() {
    ...
    echo ""
    echo -e "${CYAN}Create multiple handbooks:${NC}"
    echo "   $ onemcp handbook init my-api"
    echo "   $ onemcp handbook config my-api"
    echo "   $ onemcp chat my-api"
    echo ""
    echo -e "${CYAN}View available commands:${NC}"
    echo "   $ onemcp --help"
    echo ""
